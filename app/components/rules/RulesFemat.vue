<template>
  ...
  <UAlert
    ...
    description="Impossible de charger les règlements FEMAT. Veuillez réessayer plus tard."
  ...
  <UEmpty
    ...
    description="Les règlements FEMAT ne sont pas encore disponibles."
    variant="soft"
    size="md"
    class="my-8"
  />
...
const { data: content, pending, error } = await useAsyncData<RuleContent | null>('rules-femat', async () => {
  try {
    ...
    console.error('Erreur lors du chargement des règles FEMAT:', err)
    return null
  }
})
